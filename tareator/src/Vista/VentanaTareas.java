...
public class VentanaTareas extends javax.swing.JFrame {
    ...
    private ControladorTareas controladorcan;
    ...
    public VentanaTareas() {
        ...
        String[]columnas = {"tareas", "prioridad", "estado", "fecha limite"};
        dtm.setColumnIdentifiers(columnas);
        jTable1.setModel(dtm);
        
    }
    
    public VentanaTareas(ConexionMySql conexion) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TAREAS", "PRIORIDAD", "ESTADO", "FECHA LIMITE"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(0, 0, 580, 320);
        ...
        jButton1.setBounds(420, 360, 150, 50);
        ...
        jButton2.setBounds(0, 360, 120, 50);
        ...
        jButton3.setBounds(130, 360, 120, 50);
        ...
        jButton4.setBounds(260, 360, 150, 50);
