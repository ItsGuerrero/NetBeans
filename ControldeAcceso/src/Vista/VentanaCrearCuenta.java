...
public class VentanaCrearCuenta extends javax.swing.JFrame {
 private ConexionMySql conexion;
    ...
    public VentanaCrearCuenta(ConexionMySql conexion) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("¿Cual es el nombre de tu mascota?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      String consulta="INSERT INTO acceso(usuario,contraseña,respuesta) VALUES ('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField3.getText()+"')";
        try {
