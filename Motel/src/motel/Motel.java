...
public class Motel {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("4-Elimina huesped por nombre");
            System.out.println("5-Busca huesped por nombre");
            System.out.println("6-Buscar huesped por n de habitación");
            ...
            switch(opcion_re){
                case 1:
                    if(cont_h <= 20){
                        for(int i = 0; i < pers.length; i++){
                            if(pers[i] == null){
                                System.out.println("Dime el nombre del huesped");
                                String nom = sc.next();
                                System.out.println("Dime el número de noches que se va a quedar el huesped");
                                int num = sc.nextInt();
                                Huesped p = new Huesped(nom,num,cont_h);
                                pers[i] = p;
                                cont_h++;
                                i = pers.length;
                            }
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Dime el numero de habitacion  del huesped");
